...
export const Navbar=()=>{
    ...
    const style={height:"60px",backgroundColor:"black",display:"grid",gridTemplateColumns:"70% 10% 10% 10%",color:"white",fontFamily:"cursive"}
    const navigate=useNavigate();
     ...
     const dispatch=useDispatch();
       return (<div>
          ...
          <div style={style1} onClick={()=>{ state?  dispatch(loginState(false)): navigate("/login")  }}>{state?"Logout":"Login"}</div>
